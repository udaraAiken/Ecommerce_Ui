...
const Product = ({ product }) => {
  ...
  return (
    <div
      className="flex flex-1 items-center justify-center min-w-[300px] min-h-[350px] overflow-hidden rounded-md shadow-lg m-2 relative"
      onMouseEnter={handleHoverEffect}
      onMouseLeave={handleHoverEffectLeave}
    >
      <img src={product.src} alt="product" className="w-[400px] h-[400px]" />
      <div
        className={
